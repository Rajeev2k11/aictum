...
const HiringModelsTabs: React.FC = () => {
  ...
  const tabContents = {
    fixed: {
      ...
      image: 'https://appinventiv.com/wp-content/uploads/2019/03/Integration-of-Blockchain-and-AI-All-You-Need-to-Know_Info-1.webp', // 👈 Replace with your actual image
      features: [
        'Simplified process',
    ...
    dedicated: {
      ...
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKQJH-0kBIRcoUuRVWG2M7g35XEIaH9Qk4TQ&s', // 👈 Replace with your actual image
      features: [
    ...
    timeMaterial: {
      ...
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKbTw2gjuVi2cjMEYL0qELbzmofd8zTpz6Xw&s', // 👈 Replace with your actual image
      features: [
  ...
  return (
    <section className="py-12 px-4 bg-gradient-to-b from-[#1A1325] to-[#473062]">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Tabs */}
        <div className="flex flex-col sm:flex-row justify-center mb-6 md:mb-8 border-b border-[#473062]">
          {tabs.map((tab) => (
            <button
              key={tab.id}
