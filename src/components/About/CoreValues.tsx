    ...
    <div className="space-y-8 sm:space-y-10 md:space-y-12">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: false }}
          className="flex flex-col items-center bg-[#2e2450] rounded-xl p-6 sm:p-7 md:p-8 shadow-lg border border-purple-900/30 hover:border-purple-700 transition-all duration-300"
        >
          <div className="mb-3 sm:mb-4 text-purple-300">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Innovation</h3>
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Integrity</h3>
          <p className="text-sm sm:text-base text-purple-200 text-center leading-relaxed">
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Excellence</h3>
          <p className="text-sm sm:text-base text-purple-200 text-center leading-relaxed">
      ...
      >
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Collaboration</h3>
          <p className="text-sm sm:text-base text-purple-200 text-center leading-relaxed">
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Sustainability</h3>
          <p className="text-sm sm:text-base text-purple-200 text-center leading-relaxed">
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">Empathy</h3>
          <p className="text-sm sm:text-base text-purple-200 text-center leading-relaxed">
