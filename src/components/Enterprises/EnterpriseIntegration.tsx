...
const EnterpriseIntegration: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#180c26] px-4 py-8 md:p-12 lg:p-16 text-white flex flex-col justify-center">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-4xl font-semibold mb-8 md:mb-12 text-[#9458d5]"
        >
          Integration
        </motion.h2>
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8">
          {[FaAws, SiOkta, DiMysql].map((Icon, index) => (
            <motion.div 
              ...
              className="bg-[#27144bea] rounded-lg p-4 w-28 h-20 md:w-48 md:h-32 lg:w-56 lg:h-36 flex items-center justify-center 
                hover:scale-105 transition-transform duration-200 shadow-lg hover:shadow-[#9458d5]/30 border border-[#3a1d6e]"
            >
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-6 lg:gap-8 mb-6 md:mb-8">
          {[SiSap, DiMongodb, DiGoogleCloudPlatform, FaPaypal, FaGoogleDrive].map((Icon, index) => (
            <motion.div 
              ...
              className="bg-[#27144bea] rounded-lg p-2 w-20 h-16 md:w-40 md:h-28 lg:w-48 lg:h-32 flex items-center justify-center
                hover:scale-105 transition-transform duration-200 shadow-lg hover:shadow-[#9458d5]/30 border border-[#3a1d6e]"
            >
